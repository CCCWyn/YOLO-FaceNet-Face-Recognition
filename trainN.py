...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='', help='models/yolov5x.yaml path')#网络配置
    parser.add_argument('--data', type=str, default='/DATAset/data.yaml', help='data.yaml path')#数据
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=300)
    parser.add_argument('--batch-size', type=int, default=8, help='total batch size for all CPUs')
